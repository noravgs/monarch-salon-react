...
const Contact = () => {
 return (
  <div name='contact' className='w-full text-[#033c72] h-screen bg-[#deaaff] flex justify-center items-center p-4 pt-6'>
   <form method='POST' action="https://getform.io/f/c1900021-a4a3-456f-90df-3a7b02baba9f" className='flex flex-col max-w-[600px] w-full'>
     <div className='lg:text-4xl flex flex-col justify-center items-center sm:text-right pb-8 pl-4'>
      ...
      <p className='text-[#033c72] py-4'>Schedule your next appoitment.</p>
     </div>
     ...
     <button className='text-white border-2 px-4 py-3 my-8 mx-auto flex items-center font-bold bg-[#7209b7] hover:text-black hover:bg-[#ade1e5]'>Submit</button>
   </form>
